...
export const _customerFollowers = [...Array(18)].map((_, index) => ({
  id: _mock.id(index),
...
export const _customerFriends = [...Array(18)].map((_, index) => ({
  id: _mock.id(index),
...
export const _customerGallery = [...Array(12)].map((_, index) => ({
  id: _mock.id(index),
...
export const _customerFeeds = [...Array(3)].map((_, index) => ({
  id: _mock.id(index),
...
export const _customerCards = [...Array(21)].map((_, index) => ({
  id: _mock.id(index),
  role: _mock.role(index),
  name: _mock.fullName(index),
...
export const _customerPayment = [...Array(3)].map((_, index) => ({
  id: _mock.id(index),
...
export const _customerAddressBook = [...Array(4)].map((_, index) => ({
  id: _mock.id(index),
  primary: index === 0,
  name: _mock.fullName(index),
...
export const _customerInvoices = [...Array(10)].map((_, index) => ({
  id: _mock.id(index),
